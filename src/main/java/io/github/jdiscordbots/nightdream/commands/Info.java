...
public class Info implements Command {
    ...
    public void action(String[] args, GuildMessageReceivedEvent event) {
    	...
    	String send=String.format(
                ...
                + "\tThis is a copy of Daydream (https://gitlab.com/botstudio/daydream/) by SP46", event.getJDA().getGuilds().size(), jda.getGuilds().parallelStream().mapToInt(Guild::getMemberCount).sum(),
